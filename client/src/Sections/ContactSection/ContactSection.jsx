...
const ContactSection = () => {
  ...
  return (
    <PrimaryBox>
      <PrimaryContainer className={`grid jcs aic g50 ${styles.contact_section_box}`}>
        <Head title={"Contact Us"} />
        <Box className={`grid jcs aifs g30 ${styles.contact_section_Form}`}>
          <Form type="contact" />
          <PrimaryBox
            className={`grid jcs aic g20 ${styles.contact_data_box}`}
          >
            <Box className={`flex jcfs aic g5`}>
              <Typography variant="h5">E-mail:</Typography>
              <Typography variant="h5" className={`fw50`}>
                {teacher_email}
              </Typography>
            </Box>
            <Box className={`flex jcfs aic g5`}>
